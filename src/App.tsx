...
/* ===== CGL • TEMA BRANCO • SOMENTE VISUAL ===== */
...
header h1{color:#172033!important}
header>div>span{color:#64748b!important}
.searchBox{background:#fff!important;border-color:#d9e1ea!important}
.searchBox input{color:#172033!important}
.searchBox input::placeholder{color:#94a3b8!important}
.bell{background:#fff!important;border-color:#d9e1ea!important;color:#334155!important}
.card,.panel,.projectCard,.dashboardProgress{background:#fff!important;color:#172033!important;border-color:#dbe3ec!important;box-shadow:0 8px 26px rgba(15,23,42,.07)!important}
.card h3,.panel h2,.panel h3,.panelHeader h2{color:#172033!important}
.card p,.panel p,.panelHeader p,.muted{color:#64748b!important}
.tableWrap{background:#fff!important}
table{color:#334155!important}
th{color:#64748b!important}
td{color:#334155!important;border-color:#e5eaf0!important}
tr:hover td{background:#f8fafc!important}
.field span{color:#475569!important}
.field input,.field select,.field textarea{background:#fff!important;color:#172033!important;border-color:#cbd5e1!important}
.field input::placeholder,.field textarea::placeholder{color:#94a3b8!important}
.secondary,.cancel,.close{background:#f1f5f9!important;color:#334155!important;border-color:#cbd5e1!important}
.secondary:hover,.cancel:hover,.close:hover{background:#e2e8f0!important}
.modal{background:#fff!important;color:#172033!important;border-color:#dbe3ec!important;box-shadow:0 25px 70px rgba(15,23,42,.22)!important}
.modalHeader{border-color:#e5eaf0!important}
.modalHeader h2{color:#172033!important}
.modalHeader span{color:#64748b!important}
.authScreen{min-height:100vh!important;min-height:100dvh!important;background:#fff!important;color:#172033!important}
.authCard{background:#fff!important;color:#172033!important;border:1px solid #dbe3ec!important;box-shadow:0 20px 60px rgba(15,23,42,.12)!important}
.authCard h1{color:#172033!important}
.authSubtitle,.authHint{color:#64748b!important}
.authError{background:#fff1f2!important;color:#be123c!important;border-color:#fecdd3!important}
.authSpinner{border-color:#dbe3ec!important;border-top-color:#2388ff!important}
.authCard .field input{background:#fff!important;color:#172033!important;border-color:#cbd5e1!important}
.authCard .field span{color:#475569!important}
.primary{color:#fff!important}


/* ===== CGL • ACABAMENTO DA VERSÃO BRANCA ===== */
body{background:#fff!important}
.app,.main{background:#fff!important}

/* Áreas que ainda poderiam ficar azuladas */
.projectCard,.card,.panel,.dashboardProgress,.tableWrap{
  background:#fff!important;
}

/* Botões: azul claro como ação principal */
...
/* Ações positivas */
button.success,.success,.btnSuccess{
  background:#dcfce7!important;
  color:#15803d!important;
  border:1px solid #bbf7d0!important;
}

/* Ações de atenção/exclusão */
button.danger,.danger,.btnDanger,.deleteBtn{
...
/* Ações neutras */
button.secondary,.secondary,.cancel,.close{
  background:#f1f5f9!important;
  color:#475569!important;
  border:1px solid #cbd5e1!important;
}
button.secondary:hover,.secondary:hover,.cancel:hover,.close:hover{
  background:#e2e8f0!important;
}

/* Indicadores e chips ficam suaves */
...
.field input:focus,.field select:focus,.field textarea:focus{
  ...
  box-shadow:0 0 0 3px rgba(147,197,253,.22)!important;
}


/* =========================================================
   CGL • MODELO 2 • REPAGINAÇÃO VISUAL COMPLETA
   Paleta clara, suave e harmonizada
   ========================================================= */
:root{
  --bg:#f7f9fc!important;
  ...
  --cyan:#67e8f9!important;
  --green:#86efac!important;
  --purple:#c4b5fd!important;
  --orange:#fcd34d!important;
  --red:#fca5a5!important;

  --shadow:0 10px 28px rgba(15,23,42,.08)!important;
}

/* Base */
html,body,#root{background:#f7f9fc!important;color:#172033!important}
body{background:#f7f9fc!important;color:#172033!important}
.app{
...
/* Sidebar: mesma estrutura, acabamento mais elegante */
.sidebar{
...
/* Cards, painéis e áreas de conteúdo */
.card,.panel,.projectCard,.dashboardProgress,.tableWrap,
.itemCard,.obraPasta{
  background:#fff!important;
  color:#172033!important;
  border-color:#e2e8f0!important;
...
.card:hover,.projectCard:hover,.obraPasta:hover{
  box-shadow:0 12px 30px rgba(15,23,42,.09)!important;
}
.card h2,.card h3,.panel h2,.panel h3,
.panelHeader h2,.itemCard h3{
  color:#172033!important;
}
.card p,.panel p,.panelHeader p,.itemCard p,.muted{
...
.field input:focus,.field select:focus,.field textarea:focus{
  border-color:#93c5fd!important;
  box-shadow:0 0 0 3px rgba(147,197,253,.20)!important;
}

/* Azul principal: azul céu claro */
button.primary,.primary{
  background:#dbeafe!important;
...
/* Laranja/amarelo: atenção/pendência */
button.warning,.warning,.btnWarning{
...
.modalHeader{border-color:#e8edf3!important}
.modalHeader h2{color:#172033!important}
.modalHeader span{color:#64748b!important}
...
.authScreen{
  ...
  background:
    radial-gradient(circle at 50% 0%,rgba(147,197,253,.20),transparent 36%),
    #f7f9fc!important;
  color:#172033!important;
}
.authCard{
  ...
  box-shadow:0 22px 65px rgba(15,23,42,.11)!important;
}
.authCard h1{color:#172033!important}
.authSubtitle,.authHint{color:#64748b!important}
.authError{
...
.status-andamento,.emAndamento{
  background:#dbeafe!important;
  color:#2563eb!important;
}

/* Ações de ferramentas e controles */
.toolAction,.actionBtn{
  background:#f8fafc!important;
  color:#475569!important;
  border-color:#dbe3ec!important;
}
.toolAction:hover,.actionBtn:hover{
...
/* Regra final para impedir que o fundo geral volte ao azul antigo */
body,.app,.main,.authScreen{
