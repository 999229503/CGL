...
@media(max-width:700px){
  ...
  .toolMobileTable .toolNameCell{min-width:0}
  .toolMobileTable .toolNameCell strong{font-size:11px;line-height:1.15}
  .toolMobileTable .toolNameCell .muted{font-size:7.5px;line-height:1.15;margin-top:2px}
...
/* =========================================================
   CGL • MODELO 2 — ACABAMENTO FINAL
   Não altera estrutura, responsividade ou lógica.
   Remove qualquer resíduo visual do tema azul-marinho.
   ========================================================= */
:root{
  --bg:#f4f8fc!important;
  --panel:#ffffff!important;
...
/* Sidebar */
.sidebar{background:#fff!important;color:#243b53!important;border-right:1px solid #dce7f2!important;box-shadow:8px 0 28px rgba(36,59,83,.07)!important}
.logo{border-bottom-color:#e2ebf4!important}
.logo h1{color:#17304a!important}
.logo span,.sidebarFooter span{color:#7a8da0!important}
.nav button{background:transparent!important;color:#718399!important}
.nav button:hover{background:#f1f7fb!important;color:#17304a!important}
.nav button.active{background:#e5f3ff!important;border-color:#c9e7fb!important;color:#168fe9!important;box-shadow:inset 3px 0 0 #1597f5!important}
.sidebarFooter{border-top-color:#e2ebf4!important}
.sidebarFooter strong{color:#243b53!important}

/* Topo */
.topbar{background:#f4f8fc!important;border-color:#dce7f2!important}
header h1{color:#243b53!important}
header span{color:#718399!important}
.searchBox,.bell,.logoutBtn{background:#fff!important;color:#40566d!important;border-color:#dce7f2!important}
.searchBox input{background:transparent!important;color:#243b53!important}
.searchBox input::placeholder{color:#9aabbb!important}

/* Cards/painéis */
.card,.panel,.itemCard,.projectCard,.dashboardProgress,.obraPasta,.tableWrap{
  background:#fff!important;color:#243b53!important;border-color:#dce7f2!important;
  box-shadow:0 8px 24px rgba(36,59,83,.07)!important;
}
.card:hover,.projectCard:hover,.obraPasta:hover{border-color:#c5dceb!important;box-shadow:0 12px 30px rgba(36,59,83,.09)!important}
.cardInfo span,.panelHeader p,.itemCard p,.muted{color:#718399!important}
.cardInfo strong,.panelHeader h2,.itemCard h3{color:#243b53!important}

/* Ícones pastel */
.cardIcon{border-color:#dce7f2!important}
.dashboardCard:nth-child(1) .cardIcon,.dashboardCard:nth-child(5) .cardIcon{background:#e8f4ff!important;color:#178fe7!important;border-color:#cfe9fb!important}
.dashboardCard:nth-child(2) .cardIcon{background:#e6faf3!important;color:#18a878!important;border-color:#c6efdf!important}
.dashboardCard:nth-child(3) .cardIcon{background:#f0eaff!important;color:#805bd8!important;border-color:#ded2fa!important}
.dashboardCard:nth-child(4) .cardIcon{background:#fff3e5!important;color:#e28d32!important;border-color:#f7dfc1!important}
.dashboardCard:nth-child(6) .cardIcon{background:#fff0f3!important;color:#df5a78!important;border-color:#f5d0d9!important}

/* Botões */
.primary,button.primary{background:linear-gradient(135deg,#168ff0,#20b6f2)!important;color:#fff!important;border-color:#1597f5!important}
.secondary,.cancel,.close,button.secondary{background:#f2f7fb!important;color:#40566d!important;border-color:#d4e1ec!important}
.secondary:hover,.cancel:hover,.close:hover{background:#e7f0f7!important;color:#243b53!important}
.danger,button.danger{background:#fff0f3!important;color:#d84d6b!important;border-color:#f7ccd6!important}
.success,button.success{background:#e6faf3!important;color:#14986e!important;border-color:#bdeedc!important}
.warning,button.warning{background:#fff5e8!important;color:#c8781e!important;border-color:#f6d8ad!important}
.info,button.info{background:#f0eaff!important;color:#7452cf!important;border-color:#ddd0fb!important}

/* Registros de Materiais / Despesas / Pagamentos */
.mobileFriendlyTable tr,.toolMobileTable tr.toolUnitRow{
  background:#fff!important;color:#243b53!important;border-color:#dce7f2!important;
  box-shadow:0 4px 14px rgba(36,59,83,.045)!important;
}
.mobileFriendlyTable td,.toolMobileTable td{color:#344b61!important;border-color:#e5edf4!important;background:#fff!important}
.mobileFriendlyTable td:first-child,.toolMobileTable td:first-child{color:#243b53!important}
.mobileFriendlyTable td:last-child,.toolMobileTable tr.toolUnitRow td:last-child{border-top-color:#e5edf4!important}
.mobileFriendlyTable .mobileActionButtons button{background:#f2f7fb!important;color:#40566d!important;border-color:#d4e1ec!important}
.mobileFriendlyTable .mobileActionButtons button.danger{background:#fff0f3!important;color:#d84d6b!important;border-color:#f7ccd6!important}
...
/* Status */
.status{background:#f2f7fb!important;color:#40566d!important;border-color:transparent!important}
.status-pendente,.pendente{background:#fff5e8!important;color:#c8781e!important;border-color:#f6d8ad!important}
.status-em-andamento,.status-andamento,.emAndamento{background:#e8f4ff!important;color:#178fe7!important;border-color:#cfe9fb!important}
.status-concluido,.concluido{background:#e6faf3!important;color:#14986e!important;border-color:#bdeedc!important}

/* Progresso */
.progress{background:#e8f0f6!important}
.progressBar{background:linear-gradient(90deg,#1597f5,#2bc7f5)!important;box-shadow:0 0 12px rgba(43,199,245,.22)!important}
.progressInfo,.obraProgressHeader strong,.tarefaProgressoHeader strong{color:#1597f5!important}
.tarefaControles button,.etapaControls button{background:#f2f7fb!important;color:#496078!important;border-color:#d4e1ec!important}
.tarefaControles input,.etapaControls input{background:#fff!important;color:#243b53!important;border-color:#cbdbe8!important}

/* Obras */
.obraPastaCapa{background:#edf5fa!important;border-bottom-color:#dce7f2!important}
.obraPastaSemFoto{background:radial-gradient(circle at 50% 35%,#d9edf9,#f5f9fd 72%)!important}
.obraPastaCapaNome strong{color:#fff!important}
.obraPastaCapaNome span{color:#5ed0aa!important}
.obraPastaCorpo{background:#fff!important}
.pessoaTag,.toolUnitTag{background:#e8f5ff!important;color:#188fdc!important;border-color:#cbe7f8!important}

/* Formulários */
.field span{color:#40566d!important}
.field input,.field select,.field textarea,.toolLocationSelect{
  background:#fff!important;color:#243b53!important;border-color:#cbdbe8!important;
}
.field input::placeholder,.field textarea::placeholder{color:#9aabbb!important}
.field input:focus,.field select:focus,.field textarea:focus{border-color:#75c7f3!important;box-shadow:0 0 0 3px rgba(117,199,243,.18)!important}

/* Modais */
.modalOverlay{background:rgba(13,31,48,.42)!important}
.modal{background:#fff!important;color:#243b53!important;border-color:#dce7f2!important;box-shadow:0 24px 65px rgba(36,59,83,.18)!important}
.modalHeader{border-color:#e3ecf4!important}
.modalHeader h2{color:#243b53!important}
.modalHeader span{color:#718399!important}
.etapa,.funcionarioBox,.toolSummary,.photoEmpty,.photoCard{background:#fff!important;color:#243b53!important;border-color:#dce7f2!important}
.etapaNome,.funcionarioBox label{color:#243b53!important}
.etapaPercentual{color:#1597f5!important}

/* Fotos */
.photoCard>div{background:#fff!important}
.photoCard small,.photoViewerInfo{color:#718399!important}
.photoViewerInfo strong{color:#243b53!important}
.photoTools input[type=file]{background:#f8fbff!important;color:#718399!important;border-color:#bfd4e4!important}
.photoViewer img{background:#f4f8fc!important;border-color:#dce7f2!important}

/* Diárias */
.diaTrabalho,.resumoDiarias>div{background:#f7fafd!important;color:#253b51!important;border-color:#dce7f2!important}
.diaTrabalho.trabalhou{background:#e6faf3!important;border-color:#aee7d4!important;color:#147d5e!important}
.diaTrabalho.naoTrabalhou{background:#f7fafd!important;color:#718399!important}
.resumoDiarias span{color:#718399!important}
.resumoDiarias strong{color:#243b53!important}
.resumoDiarias>div:last-child strong{color:#14986e!important}

/* Dashboard */
.projectShade{background:linear-gradient(90deg,rgba(10,29,47,.72) 3%,rgba(10,29,47,.48) 55%,rgba(10,29,47,.12) 100%)!important}
.projectContent p{color:#d6e3ed!important}
.projectMeta span{color:#718399!important}
.projectMeta strong{color:#243b53!important}
.projectMainProgress,.projectMiniProgress{background:#e8f0f6!important}
.projectMainProgressBar,.projectMiniProgressBar{background:linear-gradient(90deg,#16cfcf,#1597f5)!important}
.projectProgressPercent{color:#243b53!important}
.projectStatus{background:#e6faf3!important;border-color:#bdeedc!important;color:#14986e!important}
.donut{background:conic-gradient(#2bc7f5 calc(var(--p)*1%),#e8f0f6 0)!important}
.donut:after{background:#fff!important}
.donut span{color:#243b53!important}
.legendRow{color:#5f7489!important}
.bar{background:linear-gradient(180deg,#2bc7f5,#1597f5)!important}

/* Erros inline e pequenos estilos antigos que escapavam */
[style*="#091522"],[style*="#0c1929"],[style*="#0d1b2d"],[style*="#0b1a2b"],[style*="#07111f"],[style*="#132338"],[style*="#102237"],[style*="#0a1726"],[style*="#0b1929"],[style*="#091725"]{
  background:#fff!important;color:#243b53!important;
}
[style*="#243b52"]{border-color:#dce7f2!important}
[style*="#ff9eb0"]{color:#d85c78!important}
...
function App() {
  ...
  const salvarAlteracaoImediata = (dados: CloudData, marcarSalvamentoDireto = true): Promise<void> => {
    ...
    if (marcarSalvamentoDireto) {
      salvamentoDiretoPendente.current = true;
    }
  ...
  const salvarGerenciamentoPessoa = async () => {
    ...
    const novasPessoas = pessoas.map((pessoa) =>
      pessoa.id === pessoaGerenciando.id
        ? {
            ...pessoa,
            diaria: Math.max(0, numero(pessoaGerenciamento.diaria)),
            pix: pessoaGerenciamento.pix.trim(),
            diasTrabalhados: { ...pessoaGerenciamento.diasTrabalhados },
          }
        : pessoa
    );
  ...
  const diasTrabalhadosSemana = diasDaSemanaAtual.filter(
  ...
  const adicionarPessoa = () => {
    ...
    const nova: Pessoa = {
      ...
      diaria: pessoaEditandoId === null ? 0 : (pessoas.find((item) => item.id === pessoaEditandoId)?.diaria || 0),
      pix: pessoaEditandoId === null ? "" : (pessoas.find((item) => item.id === pessoaEditandoId)?.pix || ""),
      tipoPix: pessoaEditandoId === null ? "Aleatória" : (pessoas.find((item) => item.id === pessoaEditandoId)?.tipoPix || "Aleatória"),
      cpf: pessoaForm.cpf.trim(),
      endereco: pessoaForm.endereco.trim(),
      diasTrabalhados: pessoaEditandoId === null ? {} : (pessoas.find((item) => item.id === pessoaEditandoId)?.diasTrabalhados || {}),
    };
    ...
    <>
      ...
      {modal === "gerenciarPessoa" && pessoaGerenciando && (
        ...
        >
          ...
          <div className="sectionTitle">🗓️ Domingo a sábado • {diasDaSemanaAtual[0].data} a {diasDaSemanaAtual[6].data}</div>
