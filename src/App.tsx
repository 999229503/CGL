...
const estilos = `
*{box-sizing:border-box}html,body,#root{margin:0;width:100%;min-height:100%;}body{font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;background:#ffffff;color:#1f2937;-webkit-user-select:none;user-select:none;-webkit-touch-callout:none;overflow-x:hidden;overflow-y:auto;touch-action:pan-y;-webkit-overflow-scrolling:touch;}button,input,select,textarea{font:inherit}button{cursor:pointer;-webkit-tap-highlight-color:transparent;-webkit-user-select:none;user-select:none}input,select,textarea{ -webkit-user-select:text; user-select:text; -webkit-touch-callout:default; }
:root{--bg:#ffffff;--panel:#0c1929;--panel2:#101f32;--line:#1b3149;--muted:#8192a8;--text:#eaf2fb;--blue:#2388ff;--cyan:#27c7ff;--green:#22c55e;--purple:#8b5cf6;--orange:#f59e0b;--red:#ef476f;--shadow:0 16px 40px rgba(0,0,0,.22)}
.app{min-height:100vh;min-height:100dvh;display:flex;background:#ffffff;overflow-x:hidden}
...
/* ===== CGL • tema claro da área de trabalho ===== */
...
.searchBox,.bell,.logoutBtn{background:#ffffff!important;color:#334155!important;border-color:#d7dee8!important}
.searchBox input{color:#172033!important}
.searchBox input::placeholder{color:#94a3b8!important}
.topDate,.syncText,.userEmail{color:#64748b!important}
header h1{color:#172033!important}
header span{color:#64748b!important}
.card,.panel,.itemCard{background:#ffffff!important;color:#172033!important;border-color:#dbe2ea!important;box-shadow:0 8px 24px rgba(15,23,42,.07)!important}
.cardInfo strong,.panelHeader h2,.itemCard h3{color:#172033!important}
.cardInfo span,.panelHeader p,.itemCard p,.muted{color:#64748b!important}
.panel{border-color:#dbe2ea!important}
.tableWrap table th,.tableWrap table td{border-color:#e2e8f0!important}
th{color:#64748b!important}
td{color:#334155!important}
tr:hover td{background:#f8fafc!important}
.secondary,.cancel{background:#f1f5f9!important;color:#334155!important;border-color:#cbd5e1!important}
.secondary:hover{background:#e2e8f0!important;color:#0f172a!important}
.close{background:#f1f5f9!important;color:#334155!important;border-color:#cbd5e1!important}
...
.modal{background:#ffffff!important;color:#172033!important;border-color:#dbe2ea!important;box-shadow:0 24px 70px rgba(15,23,42,.20)!important}
.modalHeader{border-color:#e2e8f0!important}
.modalHeader h2{color:#172033!important}
.modalHeader span{color:#64748b!important}
.projectCard,.dashboardProgress{border-color:#dbe2ea!important}
.dashboardProgress{background:#ffffff!important}
.legend strong,.legendRow{color:#334155!important}
.dashboardBottom .panel{background:#ffffff!important}
.activity{border-color:#e2e8f0!important}
.activity strong{color:#334155!important}
.activity span{color:#64748b!important}
.obraPasta{border-color:#dbe2ea!important}
`;
      return {
        nome,
        chave,
