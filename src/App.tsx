...
.projectImage{opacity:.82!important;filter:saturate(.92) brightness(1.06)!important}
.projectShade{
  background:linear-gradient(90deg,rgba(255,255,255,.70) 0%,rgba(255,255,255,.38) 42%,rgba(255,255,255,.04) 100%)!important;
}
.projectContent h3{color:#243b53!important;text-shadow:0 1px 2px rgba(255,255,255,.55)!important}
.projectContent p{color:#40566d!important}
.projectMeta span{color:#536b80!important}
.projectMeta strong{color:#243b53!important}
.projectProgressPercent{color:#243b53!important;text-shadow:0 1px 2px rgba(255,255,255,.6)!important}
