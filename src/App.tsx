...
.projectShade{
  background:linear-gradient(90deg,rgba(12,31,48,.88) 0%,rgba(12,31,48,.66) 48%,rgba(12,31,48,.18) 100%)!important;
}
.projectContent h3{color:#ffffff!important;text-shadow:0 1px 3px rgba(0,0,0,.22)!important}
.projectContent p{color:#e7f0f7!important}
.projectMeta span{color:#d5e2ec!important}
.projectMeta strong{color:#ffffff!important}
.projectProgressPercent{color:#ffffff!important;text-shadow:0 1px 3px rgba(0,0,0,.2)!important}
.projectMiniProgress,.projectMainProgress{background:rgba(232,240,246,.55)!important}
.projectMiniProgressBar,.projectMainProgressBar{
  background:linear-gradient(90deg,#2bc7f5,#1597f5)!important;
  box-shadow:0 0 10px rgba(43,199,245,.24)!important;
}
.projectStatus{
