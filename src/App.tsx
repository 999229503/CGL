...
function App() {
  ...
  const semanasPessoa = useMemo(
    () => Array.from({ length: semanasPessoaVisiveis }, (_, index) => gerarSemanaPessoa(index)),
    [semanasPessoaVisiveis]
  );
      ...
      {modal === "gerenciarPessoa" && pessoaGerenciando && (
        ...
        >
          ...
          <button
            ...
            onClick={() => setSemanasPessoaVisiveis((quantidade) => quantidade + 1)}
          >
