...
/* =========================================================
   CGL / OBRA CONTROL — TEMA FUTURISTA CLEAN • LAYOUT 01
   Camada visual: não altera a lógica ou os dados do app.
   ========================================================= */

:root {
  --cgl-bg: #07111f;
  --cgl-surface: #0c1a2b;
  --cgl-surface-2: #102238;
  --cgl-border: rgba(148, 163, 184, .16);
  --cgl-border-strong: rgba(56, 189, 248, .30);
  --cgl-text: #e8f1fb;
  --cgl-muted: #8fa4ba;
  --cgl-blue: #2f8cff;
  --cgl-cyan: #22d3ee;
...
body {
  ...
  background:
    radial-gradient(circle at 88% 4%, rgba(34, 211, 238, .07), transparent 28%),
    radial-gradient(circle at 20% 70%, rgba(47, 140, 255, .055), transparent 30%),
    var(--cgl-bg);
  color: var(--cgl-text);
}
...
.sidebar {
  ...
  padding: 24px 14px;
  background:
    linear-gradient(180deg, rgba(13, 29, 48, .98), rgba(6, 17, 30, .99));
...
.logo {
  ...
  gap: 10px;
  border-radius: 15px;
  background: linear-gradient(135deg, rgba(47,140,255,.13), rgba(34,211,238,.035));
...
.logo::before {
  ...
  border-radius: 11px;
  color: #dff8ff;
  background: linear-gradient(135deg, var(--cgl-blue), var(--cgl-cyan));
...
.nav button.active {
  color: #f3fbff;
  background: linear-gradient(90deg, rgba(47,140,255,.23), rgba(34,211,238,.065));
  border-color: rgba(34,211,238,.24);
  box-shadow:
    inset 3px 0 0 var(--cgl-cyan),
...
.onlineDot {
  color: var(--cgl-green);
  text-shadow: 0 0 12px rgba(45,212,163,.30);
}
...
.primary {
  color: #fff;
  background: linear-gradient(135deg, #2378ee, #20bde0);
  border: 1px solid rgba(125,224,255,.22);
  box-shadow: 0 8px 24px rgba(23,119,230,.18);
}
...
.secondary {
  color: #9edfff;
  background: rgba(34, 126, 190, .10);
  border: 1px solid rgba(56,189,248,.20);
}

.secondary:hover {
  color: #dff7ff;
  background: rgba(34,126,190,.17);
...
.card {
  ...
  color: var(--cgl-text);
  background:
    linear-gradient(145deg, rgba(16,34,56,.98), rgba(9,24,41,.96));
  border: 1px solid var(--cgl-border);
  border-radius: 15px;
  box-shadow:
...
.card.clickable:hover {
  ...
  border-color: var(--cgl-border-strong);
  box-shadow:
...
.cardIcon {
  ...
  border-radius: 13px;
  color: #dff7ff;
  background: linear-gradient(145deg, rgba(47,140,255,.20), rgba(34,211,238,.08));
...
/* Accent variation by dashboard card position */
.dashboardGrid .dashboardCard:nth-child(2) .cardIcon { background: rgba(45,212,163,.10); border-color: rgba(45,212,163,.20); }
.dashboardGrid .dashboardCard:nth-child(3) .cardIcon { background: rgba(139,124,255,.11); border-color: rgba(139,124,255,.20); }
.dashboardGrid .dashboardCard:nth-child(4) .cardIcon { background: rgba(247,185,85,.10); border-color: rgba(247,185,85,.20); }
.dashboardGrid .dashboardCard:nth-child(5) .cardIcon { background: rgba(34,211,238,.10); border-color: rgba(34,211,238,.20); }
.dashboardGrid .dashboardCard:nth-child(6) .cardIcon { background: rgba(251,113,133,.09); border-color: rgba(251,113,133,.18); }

/* -------- Panels / lists -------- */
.panel {
  background: linear-gradient(145deg, rgba(12,26,43,.96), rgba(8,20,34,.97));
  border: 1px solid var(--cgl-border);
  border-radius: 16px;
  padding: 21px;
  box-shadow: 0 15px 45px rgba(0,0,0,.14), inset 0 1px rgba(255,255,255,.025);
}
...
.progressBar {
  background: linear-gradient(90deg, #2378ee, #22d3ee);
  box-shadow: 0 0 13px rgba(34,211,238,.25);
}
...
.field select:focus {
  ...
  box-shadow: 0 0 0 3px rgba(34,211,238,.08), 0 0 20px rgba(34,211,238,.05);
}
...
.modal {
  color: var(--cgl-text);
  background: linear-gradient(145deg, #0d2034, #081725);
  border: 1px solid rgba(56,189,248,.16);
  box-shadow: 0 25px 90px rgba(0,0,0,.52), 0 0 45px rgba(34,211,238,.05);
}
...
.authScreen {
  background:
    ...
    radial-gradient(circle at 10% 90%, rgba(47,140,255,.12), transparent 30%),
    #06111f;
}

.authCard {
  color: #dceaf5;
  background: linear-gradient(145deg, rgba(13,32,52,.98), rgba(7,20,34,.99));
  border: 1px solid rgba(56,189,248,.18);
  box-shadow: 0 30px 100px rgba(0,0,0,.42), 0 0 50px rgba(34,211,238,.055);
}
...
.authLogo {
  background: linear-gradient(135deg, rgba(47,140,255,.20), rgba(34,211,238,.08));
  border: 1px solid rgba(56,189,248,.18);
}

.authBadge {
  background: rgba(45,212,163,.09);
  color: #75dfbf;
  border: 1px solid rgba(45,212,163,.16);
}
...
/* -------- Responsive: phone / bottom navigation -------- */
@media (max-width: 700px) {
  ...
  .nav button.active {
    box-shadow: inset 0 2px 0 var(--cgl-cyan), 0 0 18px rgba(34,211,238,.055);
    transform: none;
  }
