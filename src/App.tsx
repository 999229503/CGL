...
const adicionarEtapa = () => {
  ...
  const atividades = [
    ...
    .slice(0, 5);
  // No Dashboard, a obra em destaque é sempre a primeira obra que não está concluída.
  // A ordem original é preservada: se uma obra voltar para "Em andamento" ou "Pendente",
  // ela volta a ser considerada automaticamente para o destaque.
