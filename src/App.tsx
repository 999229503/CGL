...
function App() {
  ...
  const [ferramentaForm, setFerramentaForm] = useState({
    nome: "", marca: "", modelo: "", valorUnitario: "",
...
const adicionarEtapa = () => {
  ...
  const adicionarFerramenta = () => {
    ...
    // O cadastro é feito por ferramenta/unidade. A quantidade do formulário
    // foi removida; ferramentas já existentes com várias unidades continuam preservadas.
    const quantidade = 1;
